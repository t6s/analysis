...
Proof.
rewrite /series/= big_ord_recl /exp_ expr0n eqxx fact0 divr1; apply/eqP.
rewrite addrC eq_sym -subr_eq eq_sym subrr big1 // => /= i _.
by rewrite /bump leq0n add1n expr0n /= mul0r.
Qed.
...
Lemma dvg_harmonic (R : realType) : ~ cvg (series (@harmonic R)).
Proof.
